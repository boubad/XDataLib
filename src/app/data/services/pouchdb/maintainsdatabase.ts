...
//
import PouchDatabase = require("./pouchdatabase");
//
class MaintainsDatabase extends PouchDatabase {
  constructor(xurl?: string, gen?: InfoData.IItemGenerator) {
    super(xurl, gen);
  }// constructor
  //
  public remove_data(viewName: string): Promise<any> {
    var xdb: PouchDB = null;
  ...
  public create_persons_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
      _id: '_design/persons',
      views: {
        by_names: {
  ...
  public create_departements_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_unites_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
      _id: '_design/unites',
      views: {
        by_id: {
  ...
  public create_groupes_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
      _id: '_design/groupes',
      views: {
        by_id: {
  ...
  public create_annees_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
      _id: '_design/annees',
      views: {
        by_id: {
  ...
  public create_semestres_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_matieres_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_etudiants_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_enseignants_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_operators_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_administrators_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_profaffectations_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_etudaffectations_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
  ...
  public create_groupeevents_design_docs(): Promise<PouchUpdateResponse> {
    var ddoc = {
